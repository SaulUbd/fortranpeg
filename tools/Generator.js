...
const base = "../src/parser/visitor";
const classesDestination = path.join(__dirname, `${base}/CST.js`);
const visitorDestination = path.join(__dirname, `${base}/Visitor.js`);

let codeString = `
// Auto-generated
// Configuration found at /tools/Nodes.js
...
console.log(`Generated visitor Interface at ${visitorDestination}`);
...
console.log(`Generated syntax tree classes at ${classesDestination}`);
